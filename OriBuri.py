...
######    Copyright(c) 2023 GEO-CODING                               #
######                   Sejong Univ. Earth Resource engineering,    #
...
######     Hoyeong, Yeou (Energy resource engineering)               #
######     Taeseok, Lim (Energy resource engineering)                #
######     Daye, Joen    (Earth resource engineering)                #
######     Jungki, Kim   (Earth resource engineering)                #
######                                                               #
######################################################################
...
def getFBR (product, alpha, enl):
    ...
    print('#########################################################')
    print('')
    print('Frozen Background Refernce image')
    print('')
    print('reference: ')
    print('')
...
def cfar_db(data, alpha, win_size):
    ...
    win_size: must be integer odd number
    '''
    print('CFAR algorithm using decibel image')
    print('')
    im = data.copy()
    a, b = im['Band'].shape
    target_pixel = win_size // 2 + 1
